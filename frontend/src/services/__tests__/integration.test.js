import { authService, bookingService, userService, notificationService } from '../index';
...
describe('Service Integration Tests', () => {
  ...
  describe('Service Method Integration', () => {
    test('booking service methods use correct endpoints', async () => {
      ...
      expect(apiClient.post).toHaveBeenCalledWith('/bookings', { labId: 'lab1' });
    ...
    test('user service methods handle user data correctly', async () => {
      ...
      apiClient.put.mockResolvedValue({ user: { ...mockUser, name: 'Updated' } });
    ...
    test('notification service handles different notification types', async () => {
      ...
      expect(apiClient.post).toHaveBeenCalledWith('/notifications', { message: 'Test' });
